...
if (isset($_POST['submit'])) {
    ...
    if (move_uploaded_file($tmpname1, $folder1)) {
        ...
        if (move_uploaded_file($tmpname2, $folder2)) {
            ...
            $sql = "INSERT INTO `psrtykaftan`(`image1`, `image2`, `name`, `price`) VALUES ('$image1', '$image2', '$name', '$price')";
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post" enctype="multipart/form-data">
                            ...
                            <input type="submit" name="submit" value="Add Kaftan">
                        </form>
