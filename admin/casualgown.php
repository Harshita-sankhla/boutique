...
if (isset($_GET['delete_id'])) {
    ...
    $fetchQuery = "SELECT image1, image2 FROM casualgown WHERE sno = '$id'";
...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_POST['uid'])) {
        ...
        $fetchQuery = "SELECT image1, image2 FROM casualgown WHERE sno = '$uid'";
        $fetchResult = mysqli_query($conn, $fetchQuery);
        if ($fetchResult && mysqli_num_rows($fetchResult) > 0) {
            ...
            $sql = "UPDATE `casualgown` SET `image1`='$image1', `image2`='$image2', `name`='$name', `price`='$price' WHERE `sno`='$uid'";
        ...
        if (!empty($image1) && move_uploaded_file($tmpname1, $folder1) && !empty($image2) && move_uploaded_file($tmpname2, $folder2)) {
            $sql = "INSERT INTO `casualgown`(`image1`, `image2`, `name`, `price`) VALUES ('$image1', '$image2', '$name', '$price')";
            $result = mysqli_query($conn, $sql);
            if ($result) {
