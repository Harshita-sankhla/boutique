...
if (isset($_GET['uid']) && is_numeric($_GET['uid'])) {
    $uid = $_GET['uid'];
    echo "Debug: UID is $uid <br>"; // Debug: Check if uid is being passed correctly

    $editQuery = "SELECT * FROM `arrival` WHERE `sno` = '$uid'";
    $editResult = mysqli_query($conn, $editQuery);
    if ($editResult) {
        $editRow = mysqli_fetch_assoc($editResult);
    } else {
        echo "Error: " . mysqli_error($conn) . "<br>"; // Print SQL errors if any
    }
}
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post" enctype="multipart/form-data">
                            ...
                            <input type="submit" name="submit" value="Add Lehenga">
                        </form>
